...
class ViewController: UIViewController {
    ...
    static let users = [
        User(username: "siloh117", password: "aL,189", state: "california", zipCd: "20735"),
        User(username: "jordy09", password: "Pn76Ba..", state: "delaware", zipCd: "20735"),
        User(username: "kramer54", password: "09jsuW", state: "florida", zipCd: "20735"),
        User(username: "stepht633", password: "6jGFba", state: "new-york", zipCd: "20735"),
        User(username: "les905", password: "G67ag.", state: "new-jersey", zipCd: "20735"),
    ]
